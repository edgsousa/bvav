...
public class GsmTransport implements SmsTransport
{
    ...
    protected SerialComm serialComm_ = null;
     ...
     * @throws IOException
     */
    public String send(final SmsMessage msg, final SmsAddress dest, final SmsAddress sender) throws SmsException, IOException
    {
